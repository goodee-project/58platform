                 ...
                 <div class="header-message-list p-2">
                     <a class="dropdown-item" href="#">
                       <div class="d-flex align-items-center">
                          <img src="/58platform/assets/images/avatars/avatar-1.png" alt="" class="rounded-circle" width="50" height="50">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="/58platform/assets/images/avatars/avatar-2.png" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="/58platform/assets/images/avatars/avatar-3.png" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="/58platform/assets/images/avatars/avatar-4.png" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="/58platform/assets/images/avatars/avatar-5.png" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex align-items-center">
                         <img src="/58platform/assets/images/avatars/avatar-6.png" alt="" class="rounded-circle" width="50" height="50">
                         <div class="ms-3 flex-grow-1">
