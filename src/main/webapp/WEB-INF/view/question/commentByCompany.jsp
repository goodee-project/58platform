		...
		<script>
			$(document).ready(function() {
				...
				$('#addCancelBtn').click(function() {
					...
					if(result == true) { 
						$(location).attr("href", "${pageContext.request.contextPath}/employee/question/questionListByCompany?serviceName=${serviceName}");
					} else {
						return false;
					}
				});
								...
								<li class="breadcrumb-item">
									<c:if test="${serviceName eq '쇼핑'}">
										<li class="breadcrumb-item active" aria-current="page">
											<a href="${pageContext.request.contextPath}/employee/question/questionListByCompany?serviceName=쇼핑">
												<i class="bi bi-question-circle-fill"></i>&nbsp;문의조회(쇼핑)
											</a>
										</li>
									</c:if>
									<c:if test="${serviceName == '예약'}">
										<li class="breadcrumb-item active" aria-current="page">
											<a href="${pageContext.request.contextPath}/employee/question/questionListByCompany?serviceName=예약">
												<i class="bi bi-question-circle-fill"></i>&nbsp;문의조회(예약)
											</a>
										</li>
									</c:if>
								</li>
								<c:if test="${m.questionComment eq null}">
									<li class="breadcrumb-item active" aria-current="page">답변작성</li>
								</c:if>
								<c:if test="${m.questionComment ne null}">
									<li class="breadcrumb-item active" aria-current="page">답변수정</li>
								</c:if>
							</ol>
						</nav>
					</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="border p-3 rounded">
											<form class="row g-3" action="${pageContext.request.contextPath}/employee/question/addCommentByCompany" method="post" id="addForm">
												...
												<div class="col-12">
													...
													<input type="text" class="form-control" value="${m.questionTitle}" readonly="readonly">
												</div>
												<div class="col-12">
													<label class="form-label">문의분류</label>
													<input type="text" class="form-control" value="${m.serviceName}" readonly="readonly">
												</div>
												<div class="col-12">
													<label class="form-label">문의기업</label>
													<input type="text" class="form-control" value="${m.companyName}" readonly="readonly">
												</div>
												<div class="col-12">
													<label class="form-label">문의내용</label>
													<textarea class="form-control" rows="6" cols="4" readonly="readonly">${m.questionMemo}</textarea>
												</div>
												<div class="col-12">
													<label class="form-label">답변</label>
													<textarea class="form-control" rows="6" cols="4" name="questionComment" id="question"></textarea>
												</div>
												<div class="col-12">
													<button class="btn btn-primary px-4" type="button" id="addBtn">답변등록</button>
													<a id="addCancelBtn" class="btn btn-primary px-4">취소</a>
												</div>
											</form>
										</div>
									</div>
						...
						<div class="row">
							<div class="col-lg-8 mx-auto">
								<div class="card">
									...
									<div class="card-body">
										<div class="border p-3 rounded">
											<form class="row g-3" action="${pageContext.request.contextPath}/employee/question/modifyCommentByCompany" method="post" id="modifyForm">
												<input type="hidden" name="questionNo" value="${m.questionNo}">
												<input type="hidden" name="serviceName" value="${m.serviceName}">
												<div class="col-12">
													<label class="form-label">문의제목</label>
												...
												<div class="col-12">
													<label class="form-label">답변</label>
													<textarea class="form-control" rows="6" cols="4" name="questionComment" id="answer">${m.questionComment}</textarea>
												</div>
												<div class="col-12">
													<button class="btn btn-primary px-4" type="button" id="modifyBtn">답변수정</button>
													<a id="modifyCancelBtn" class="btn btn-primary px-4">취소</a>
												</div>
											</form>
										</div>
									</div>
